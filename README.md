...
```go
import "github.com/charles-stanhope/go-squirrel"
```

Squirrel helps you build SQL queries from composable parts:

```go
import sq "github.com/charles-stanhope/go-squirrel"
...
* **How can I build an IN query on composite keys / tuples, e.g. `WHERE (col1, col2) IN ((1,2),(3,4))`? ([#104](https://github.com/charles-stanhope/go-squirrel/issues/104))**
...
* **Why doesn't `Eq{"mynumber": []uint8{1,2,3}}` turn into an `IN` query? ([#114](https://github.com/charles-stanhope/go-squirrel/issues/114))**
